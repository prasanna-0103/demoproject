		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item">Plan</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index1.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="<?php echo $row['productImage1'];?>" alt="" width="114" height="146">
						</a>
					</td>
